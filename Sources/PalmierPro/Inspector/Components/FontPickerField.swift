...
struct FontPickerField: View {
    ...
    private func presentMenu() {
        ...
        if !BundledFonts.families.isEmpty {
            let header = NSMenuItem(title: loc("Featured"), action: nil, keyEquivalent: "")
            ...
            let all = NSMenuItem(title: loc("All fonts"), action: nil, keyEquivalent: "")
            all.isEnabled = false
            menu.addItem(all)
        }
    ...
    private var displayName: String {
        guard let current else { return loc("Mixed") }
